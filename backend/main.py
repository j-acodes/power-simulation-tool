...
def _transformer_info(
    ...
    return TransformerInfo(
        ...
        datasheet_date=tx.datasheet_date,
        market=tx.market,
        preliminary=tx.preliminary,
        transformer_type=tx.transformer_type,
        transformer_tappings=tx.transformer_tappings,
        transformer_oil_type=tx.transformer_oil_type,
        transformer_efficiency=tx.transformer_efficiency,
        maximum_input_current=tx.maximum_input_current,
        lv_panel_segregation=tx.lv_panel_segregation,
        lv_main_switches=tx.lv_main_switches,
        lv_inverter_switches=tx.lv_inverter_switches,
        auxiliary_transformer=tx.auxiliary_transformer,
        auxiliary_output_voltage=tx.auxiliary_output_voltage,
        transformer_protection=tx.transformer_protection,
        internal_arc_classification=tx.internal_arc_classification,
        ac_input_protection=tx.ac_input_protection,
        optional_features=tx.optional_features,
        weight_specification=tx.weight_specification,
